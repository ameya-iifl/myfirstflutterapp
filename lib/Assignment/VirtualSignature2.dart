...
class VirtualSignature2 extends StatefulWidget {

   VirtualSignature2({Key? key}) : super(key: key);

  @override
  State<VirtualSignature2> createState() => _VirtualSignatureState2();
}

class _VirtualSignatureState2 extends State<VirtualSignature2> {
